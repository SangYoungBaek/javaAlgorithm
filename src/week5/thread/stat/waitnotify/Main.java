package week5.thread.stat.waitnotify;
...
Customer1 Waiting!
Customer2 Waiting!
Inventory 현황: [AirPods, AirPods, iMac]
Customer1 Waiting!
Inventory 현황: [AirPods, AirPods, iMac, AirPods]
Customer2 Waiting!
Inventory 현황: [AirPods, AirPods, iMac, AirPods, IPhone]
Customer1 Waiting!
StoreClerk Waiting! -> 병목현산 발생!!!

병목현상 -> a와 b가 서로의 기다리는 현상
 */